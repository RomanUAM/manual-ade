...
\section{Resultados experimentales: Equipo 1}

\subsection{Tablas de frecuencias}

\subsubsection{\texorpdfstring{Resultados para \(n=2\)}{Resultados para n=2}}
...
\subsubsection{\texorpdfstring{Resultados para \(n=5\)}{Resultados para n=5}}
...
\subsubsection{\texorpdfstring{Resultados para \(n=10\)}{Resultados para n=10}}
...
\subsubsection{\texorpdfstring{Resultados para \(n=15\)}{Resultados para n=15}}
...
\subsubsection{\texorpdfstring{Resultados para \(n=20\)}{Resultados para n=20}}
...
\section{Resultados experimentales: Equipo 2}
...
\section{Comparación entre equipos: convergencia de la media}
...
\subsection{Boxplots comparativos}
...
\section{El Teorema Central del Límite: aclaración fundamental}
...
\subsection{¿Qué dice realmente el TCL?}
...
\subsection{Experimento mental con los gatos}
