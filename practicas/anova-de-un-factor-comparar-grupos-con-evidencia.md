# ANOVA de un factor: comparar grupos con evidencia
...
Construir una practica de ANOVA de un factor a partir de la fuente indicada y convertirla en una actividad didactica verificable.

## Evidencia de partida

- Fuente principal: `data/raw/curso-2026p/ANOVA-de-un-factor-Prueba-F-y-valor-P.pdf`
